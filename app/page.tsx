...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link href="/signup">
                <div className="relative overflow-hidden group">
                  <Button className="relative z-10 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white shadow-md hover:shadow-lg transition-all duration-300 text-lg px-8 py-6 rounded-xl">
                    <span className="relative z-10">Sign up</span>
                    <span className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></span>
                    <span className="absolute inset-0 w-0 h-full bg-white/20 transition-all duration-500 group-hover:w-full rounded-xl"></span>
                  </Button>
                </div>
              </Link>
            </div>
      ...
      <section id="home" className="pt-32 pb-16 md:pt-40 md:pb-24" style={{ background: 'linear-gradient(to right, #9B5DE5, #3C1A5B)' }}>
